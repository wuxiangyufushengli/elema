      ...
      <div class="overview">
        ...
        <div class="overview-right">
          <div class="score-wrapper">
            ...
            <Star :score="shopInfo.serviceScore" :size="36"></Star>
...
<script>
    ...
    import RatingSelecte from '../../../components/Ratingselect/Ratingselect.vue'
    ...
    export default {
      ...
      computed:{
        ...mapState(['shopgoods','shopInfo','shopratings']),
        filterratings(){
